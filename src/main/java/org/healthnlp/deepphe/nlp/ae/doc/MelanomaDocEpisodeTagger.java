 ...
 * @author Chen Lin
 */
final public class MelanomaDocEpisodeTagger extends CleartkAnnotator<String> {

   static private final String CLASSIFIER_JAR_PATH = "classifierJarPath";

   static private final String MELANOMA_MODEL = "/org/healthnlp/deepphe/episode/melanoma/model.jar";
   ...
   public void initialize( final UimaContext context ) throws ResourceInitializationException {
      ...
      mutableContext.setConfigParameter( CLASSIFIER_JAR_PATH, MELANOMA_MODEL );
